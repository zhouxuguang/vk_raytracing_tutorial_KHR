...
**Documentation**: It is strongly recommended to read the [acceleration structure](/docs/acceleration_structures.md) document at this point. It explains the concepts and the helpers used here.
...
**📖Documentation**: It is strongly recommended to read the [shader binding table](/docs/shader_binding_table.md) document at this point. It explains the concepts and implementation details.
